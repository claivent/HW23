...
export const Content = createVisualComponent({
  ...
  render(props) {
    //@@viewOn:private
    const { slistDataList,  ...tileProps } = props;
    const pageSize = slistDataList.pageSize;
    ...
    return (
      <div {...attrs}>
        <FilterBar disabled={slistDataList.state !== "ready"} />
        <SorterBar disabled={slistDataList.state !== "ready"} />
        <Grid
